...
<div class="mws-panel grid_8">
    ...
    <div class="mws-panel-body no-padding">
        ...
        @endif
        	...
        	<form action="/admin/abv" method='get'>
	            <div id="DataTables_Table_1_length" class="dataTables_length">
                    ...
                    <font style="vertical-align: inherit;">
                        <font style="vertical-align: inherit;">
                            <a href="/admin/abv/create" class="btn btn-info">添加广告</a>
                        </font>
                    </font>
                </label>
	            </div>
            ...
            aria-describedby="DataTables_Table_1_info">
                ...
                <tbody role="alert" aria-live="polite" aria-relevant="all">
                    ...
                    @endif
                        ...
                        <td class=" ">
                            <img src="{{$v->aimg}}" width="50px">
                        </td>
                        <td class=" ">
                            {{$v->status? '显示':'隐藏'}}
                        </td>
                        <td class=" ">
                            <a class='btn btn-warning' href="/admin/abv/{{$v->id}}/edit">修改</a>

                            <form style='display:inline' action="/admin/abv/{{$v->id}}" method='post'>
                                {{csrf_field()}}
